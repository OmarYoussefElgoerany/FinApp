        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankAccountReceiverId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transfers_BankAccounts_BankAccountReceiverId",
                        column: x => x.BankAccountReceiverId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transfers_BankAccountReceiverId",
                table: "Transfers",
                column: "BankAccountReceiverId");
